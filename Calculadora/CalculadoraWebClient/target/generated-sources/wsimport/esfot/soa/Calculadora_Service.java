 ...
 * 
 */
@WebServiceClient(name = "Calculadora", targetNamespace = "http://soa.esfot/", wsdlLocation = "http://localhost:8080/Calculadora/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORA_QNAME = new QName("http://soa.esfot/", "Calculadora");
    ...
    public Calculadora getCalculadoraPort() {
        return super.getPort(new QName("http://soa.esfot/", "CalculadoraPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soa.esfot/", "CalculadoraPort"), Calculadora.class, features);
    }
