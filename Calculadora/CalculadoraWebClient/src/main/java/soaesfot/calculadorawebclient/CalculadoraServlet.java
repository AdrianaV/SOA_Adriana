 ...
 */
package soaesfot.calculadorawebclient;
...
import esfot.soa.Calculadora_Service;
 ...
 * @author ANYTA
 */
@WebServlet(name = "Calculadoraaa", urlPatterns = {"/Calculadora"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try { // Obtenemos el Port
                esfot.soa.Calculadora port = service.getCalculadoraPort();
                ...
                Integer result = port.suma(x, y);
                

                out.println("Primer numero= " + numx);
                out.println("Segundo numero= " + numy);
